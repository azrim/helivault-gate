    ...
    <div className="container mx-auto py-12">
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Select the automation contracts you wish to deploy to the Helios
            network. Your deployment progress will be preserved even if you
            navigate away.
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="flex items-center gap-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleSelectContract(contract.name, !!checked)
                    }
                    disabled={isDeploying}
                  />
                  <label
          ...
          <Button
            ...
            disabled={
              isDeploying ||
              !isConnected ||
              Object.values(selectedContracts).every((v) => !v)
            }
            className="w-full"
          >
            {isDeploying
