...
const Home = () => {
  return (
    <Page
      title="HLS Faucet for Testnet"
      description="Get free HLS tokens for the Helios testnet. Use our faucet to start testing and developing on the Helios blockchain."
    >
      <div className="space-y-24 pb-24">
        ...
        <section className="text-center pt-24 pb-16">
          ...
          >
            Your portal to the decentralized ecosystem on Helios. Engage with
            our dApps, win prizes, and mint unique NFTs.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <section className="text-center">
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto">
            Helivault Gate is a community-focused platform designed to showcase
            the power and flexibility of the Helios blockchain. Our goal is to
            provide a suite of useful and engaging dApps that make it easy for
            users to explore the world of decentralized applications. Whether
            you're a developer, an NFT collector, or just curious about crypto,
            Helivault Gate is your entry point to the future of the
            decentralized web.
          </p>
        </section>
      </div>
